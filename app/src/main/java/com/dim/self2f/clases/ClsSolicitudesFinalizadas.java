...
public class ClsSolicitudesFinalizadas {
	static private ClsSolicitudesFinalizadas instancia;
	private int iDFolio;
	...
	public ClsSolicitudesFinalizadas() {
		setIDFolio(0);
		setFechaCaptura("");
		setFolioAgencia("");
		setFolioInteligente("");
	...
	static public ClsSolicitudesFinalizadas getInstancia() {
		if (instancia == null) {
			instancia = new ClsSolicitudesFinalizadas();
		}
		return instancia;
	}
